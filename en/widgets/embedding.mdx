...
- **[Project Management]( /en/projects/creation)** - Create and configure projects for widgets
- **[Lead Management]( /en/leads/overview)** - Track leads from embedded widgets
- **[Custom Domains]( /en/domains/setup)** - Use custom domains for widgets
